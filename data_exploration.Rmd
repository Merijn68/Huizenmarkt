...
Het lineair regressiemodel geeft duidelijk een minder goede fit dan het time series model en het MARS model. Het MARS model sluit heel goed aan bij de ontwikkeling van de huizenprijzen over de afgelopen vijf jaar.
...
checkresiduals(fit, test = FALSE, color = 'steelblue' )
